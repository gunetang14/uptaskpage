(function() {
    ...
    let tareas = [];
    let filtradas = [];
    //boton para motral el modal de agregar tarea
    ...
    function mostrarFormulario(editar = false, tarea = {}) {
        ...
        modal.addEventListener('click', function(e) {
            e.preventDefault(); //para evitar la accion por default (aqui envia formulario y cierra el modal)
        ...
        try {
            ...
            if(resultado.tipo === 'exito') {
                ...
                const tareaObj = {
                    ...
                    nombre: tarea,
                    estado: "0",
                    proyectiId: resultado.proyectoId
                }
